...
import { Star, Dna, Banknote, Truck, Stethoscope, Gift } from "lucide-react";
...
const Homepage: React.FC = () => {
  ...
  const [lifestyle, setLifestyle] = useState<{
    ...
    routine: string[];
    career: string;
  }>({ habit: [], fun: [], routine: [], career: "" });

  const [preference, setPreference] = useState<{
    drugForm: string[];
    minBudget: string;
    maxBudget: string;
  }>({ drugForm: [], minBudget: "", maxBudget: "" });
  ...
  useEffect(() => {
    if (isAuthenticated && user?.role) {
      ...
      else if (user.role === "benfek") navigate("/benfek");
    }

    const shouldShow = window.sessionStorage.getItem("showQuizModal");
    if (shouldShow === "true") {
  ...
  const testimonials = [
    {
      name: "Avwenagha Bose",
      content:
        "The services I received from HLS are excellent. Great experience with professional staff",
      rating: 5,
      image: bose,
    },
    {
      ...
      content:
        "Professional services with top-notch customer care! Learned so much about supplements and healthy living. Prices are very affordable.",
      rating: 5,
      image: joy,
    },
    {
      name: "Walker Okolie",
      content:
        "They prioritize your wellbeing over profits. They don't just deliver, but follow up to ensure you're doing well.",
      rating: 5,
      image: walter,
    },
    {
      name: "Samson Ojo",
      content:
        "Extremely competitive prices with first-class service. HLS adds tremendous value with nutritional education.",
      rating: 5,
      image: samson,
    },
    {
      name: "Nick Okunzuwa",
      content:
        "Great insight to healthy living! The education about proper supplementation has been life-changing.",
      rating: 5,
      image: nick,
    },
    {
      name: "Ericsyl John",
      content:
        "Their prompt response is impressive! They take time to educate me on the right supplements for my needs",
      rating: 5,
      image: eriscyl,
    },
    {
      name: "Mimi Gloria",
      content:
        "For getting the best supplements and nutrition, you can never go wrong with HLS.",
      rating: 5,
      image: mimi,
    },
    {
      name: "Olivia Njoku",
      content:
        "HLS provides a new level of understanding about how the lifestyle choices you make impact the biological processes in your body. I've seen great improvements in my health over 2 years.",
      rating: 5,
    ...
    },
    {
      name: "Kenny Ajayi",
      content:
        "Very reliable company! They deliver to your doorstep without any worries.",
      rating: 5,
      image: "/placeholder.svg",
    },
  ];
  ...
  const products = [
    ...
    },
    {
      ...
      image: vitamins3,
      description:
        "Highly absorbable magnesium for muscle and nerve function",
  ...
  const faqs = [
    {
      ...
      answer:
        "Our scientifically-designed quiz assesses your lifestyle, health goals, and dietary needs to provide personalized supplement recommendations.",
    },
    {
      question: "Are your supplements third-party tested?",
      answer:
        "Yes, all our supplements undergo rigorous third-party testing for purity, potency, and safety.",
    },
    {
      question: "Can I change my subscription?",
      answer:
        "Absolutely! You can modify, pause, or cancel your subscription at any time through your dashboard.",
    },
    {
  ...
  const blogs = [
    ...
    },
    {
      ...
      excerpt:
        "Understand how magnesium plays a crucial role in muscle recovery and why it's essential for active individuals.",
      date: "March 5, 2024",
      image: "/placeholder.svg",
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative bg-[#e0f2fe] pt-4 pb-0 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-20 text-center">
          <div className="pt-8 sm:pt-16 lg:pt-20 pb-4 sm:pb-8">
            ...
            {/* UPDATED HERO COPY */}
            <h1 className="text-2xl sm:text-4xl lg:text-6xl font-extrabold text-blue-900 mb-3 sm:mb-4 leading-tight">
              Personalized wellness, built around you.
            </h1>
            <p className="text-gray-700 text-xs sm:text-base lg:text-lg max-w-2xl mx-auto mb-6 sm:mb-8">
              Take a quick assessment and get supplement recommendations that match your goals, lifestyle, and budget.
            </p>
            ...
            <div className="flex justify-center gap-3 sm:gap-4 mb-8 sm:mb-12">
              ...
              <Link
                to="/marketplace"
                className="border border-emerald-600 text-emerald-700 hover:bg-emerald-50 px-6 py-2 sm:px-8 sm:py-3 rounded-lg text-sm sm:text-base font-semibold transition-colors"
              >
                Shop Supplements
              </Link>
            </div>
      ...
      <section className="py-8 sm:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-12">
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-2 sm:mb-4">
              Featured Products
            </h2>
                ...
                <CarouselItem key={product.id} className="basis-full sm:basis-1/2 lg:basis-1/4">
                  <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow h-full">
                    ...
                    <div className="p-3 sm:p-6">
                      ...
                      <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 hidden sm:block">
                        {product.description}
                      </p>

                      <div className="flex items-center justify-between">
                        <span className="text-sm sm:text-xl lg:text-2xl font-bold text-emerald-600">
                          ₦{product.price.toLocaleString()}
                        </span>

                        {/* FIX: OPTION A - route to product page */}
                        <Link
                          to={`/product/${product.id}`}
                          className="bg-orange-500 hover:bg-orange-600 text-white px-2 sm:px-4 py-1 sm:py-2 rounded-md transition-colors text-xs sm:text-sm inline-flex items-center justify-center"
                        >
                          View Product
                        </Link>
                      </div>
      ...
      <section className="py-8 sm:py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Accordion type="single" collapsible className="w-full bg-white rounded-lg shadow-md">
            {faqs.map((faq, index) => (
              <AccordionItem key={index} value={`faq-${index}`} className="px-3 sm:px-6">
                <AccordionTrigger className="text-left text-sm sm:text-lg font-semibold text-gray-900">
                  {faq.question}
                </AccordionTrigger>
                <AccordionContent className="text-gray-700 text-xs sm:text-base pb-4">
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
      ...
      {/* Blog Section (FIXED: only last 3 show images) */}
      <section className="py-8 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-12">
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-2 sm:mb-4">
          ...
          <Carousel className="w-full">
            <CarouselContent>
              {blogs.map((blog, index) => {
                const showImage = index >= blogs.length - 3;
                return (
                  <CarouselItem key={blog.id} className="basis-full sm:basis-1/2 lg:basis-1/3">
                    <article className="bg-gray-50 rounded-lg overflow-hidden hover:shadow-lg transition-shadow h-full flex flex-col">
                      ...
                      <div className="p-3 sm:p-6 flex-1 flex flex-col">
                        ...
                        <h3 className="text-sm sm:text-lg lg:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">
                          {blog.title}
                        </h3>
                        <p className="text-gray-700 mb-2 sm:mb-4 flex-1 text-xs sm:text-sm lg:text-base">
                          {blog.excerpt}
                        </p>
                        <Link
                          to={`/blog/${blog.id}`}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2">
                <li>
                  <Link to="/about" className="text-gray-400 hover:text-white text-xs sm:text-sm">
                    About Us
                  </Link>
                </li>
                <li>
                  <button onClick={handleQuizStart} className="text-gray-400 hover:text-white text-xs sm:text-sm">
                    Take Quiz
                  </button>
                </li>
                <li>
                  <Link to="/support" className="text-gray-400 hover:text-white text-xs sm:text-sm">
                    Support
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2">
                <li>
                  <Link to="/support#faq" className="text-gray-400 hover:text-white text-xs sm:text-sm">
                    Help Center
                  </Link>
                </li>
                <li>
                  <Link to="/support#contact" className="text-gray-400 hover:text-white text-xs sm:text-sm">
                    Contact Us
                  </Link>
                </li>
                <li>
                  <Link to="/support#privacy" className="text-gray-400 hover:text-white text-xs sm:text-sm">
                    Privacy Policy
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2">
                <li>
                  <Link to="/support#newsletter" className="text-gray-400 hover:text-white text-xs sm:text-sm">
                    Newsletter
                  </Link>
                </li>
                <li>
                  <Link to="/support#social" className="text-gray-400 hover:text-white text-xs sm:text-sm">
                    Social Media
                  </Link>
                </li>
                <li>
                  <Link to="/support#community" className="text-gray-400 hover:text-white text-xs sm:text-sm">
                    Community
                  </Link>
                </li>
              </ul>
            ...
            {nutrientStep === 0 && (
              <div className="space-y-4">
                ...
                <div className="flex justify-end gap-2">
                  <Button type="button" onClick={handleNutrientNext}>
                    Next
                  </Button>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      value={lifestyle.habit.join(",")}
                      onChange={(e) =>
                        setLifestyle((l) => ({
                          ...l,
                          habit: e.target.value.split(",").map((s) => s.trim()).filter(Boolean),
                        }))
                      }
                  ...
                  <div>
                    ...
                    <Input
                      value={lifestyle.fun.join(",")}
                      onChange={(e) =>
                        setLifestyle((l) => ({
                          ...l,
                          fun: e.target.value.split(",").map((s) => s.trim()).filter(Boolean),
                        }))
                      }
                  ...
                  <div>
                    ...
                    <Input
                      value={lifestyle.routine.join(",")}
                      onChange={(e) =>
                        setLifestyle((l) => ({
                          ...l,
                          routine: e.target.value.split(",").map((s) => s.trim()).filter(Boolean),
                        }))
                      }
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      value={preference.drugForm.join(",")}
                      onChange={(e) =>
                        setPreference((p) => ({
                          ...p,
                          drugForm: e.target.value.split(",").map((s) => s.trim()).filter(Boolean),
                        }))
                      }

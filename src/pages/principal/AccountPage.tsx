    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 overflow-hidden">
      ...
      <Card className="w-full max-w-md p-6 shadow-lg">
        <div className="flex flex-wrap items-center justify-between mb-2">
          <span className="font-bold text-base">Account Transactions</span>
          <span className="font-medium text-base">Account Balance: <span className="font-bold">₦0</span></span>
        </div>
        <hr className="my-2" />
        <div className="bg-gray-50 rounded border p-3 text-center text-sm font-medium">
          Egazu Points: Free Trial (31 days validity)
        </div>
      </Card>
    </div>
  );

...
const SignUpWholesalerPage: React.FC = () => {
      ...
      <div className="w-full max-w-md">
        <Card className="w-full">
          <CardHeader className="text-center">
            ...
            <CardTitle>Sign Up as Wholesaler</CardTitle>
            <CardDescription>Create your seller account to list products</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {isLoading ? 'Creating Account...' : 'Create Wholesaler Account'}
              </Button>
...
export default SignUpWholesalerPage;
